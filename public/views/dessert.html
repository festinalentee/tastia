...
<div class="base-container">
    <nav>
        ...
        <ul>
            ...
            <li>
                ...
                <a href="#" class="selected">Dessert</a>
            </li>
            <li>
    ...
    <main>
        ...
        <section class="allRecipes">
            <div id="recipe-1">
                <img src="public/img/image-24@1x.png">
                <div>
                    <h2>Pancakes</h2>
                </div>
            </div>
            <div id="recipe-2">
                <img src="public/img/image-25@1x.png">
                <div>
                    <h2>Cookies</h2>
                </div>
            </div>
            <div id="recipe-3">
                <img src="public/img/image-26@1x.png">
                <div>
                    <h2>Donuts</h2>
                </div>
            </div>
            <div id="recipe-4">
                <img src="public/img/image-27@1x.png">
                <div>
                    <h2>Cupcakes</h2>
                </div>
            </div>
            <div id="recipe-5">
                <img src="public/img/image-28@1x.png">
                <div>
                    <h2>Ice cream</h2>
                </div>
            </div>
            <div id="recipe-6">
                <img src="public/img/image-5@1x.png">
                <div>
                    <h2>Apple pie</h2>
                </div>
            </div>
